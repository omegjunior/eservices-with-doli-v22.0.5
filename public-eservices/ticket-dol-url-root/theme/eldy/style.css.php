...
if($mybasename == 'ticket'){// cas où on a un DOL_URL_ROOT ce qui fait que le niveau 3 de _DIR_ donne ticket
...
//$myfunctionfile = $maindirectorylevel. DIRECTORY_SEPARATOR.'core'.DIRECTORY_SEPARATOR.'lib'.DIRECTORY_SEPARATOR.'functions2.lib.php';

if (file_exists($mymainfile)) {
	require_once $mymainfile; 
	//require_once $myfunctionfile;
