...
/**
 *		\file       htdocs/custom/eservices/ticket/agenda.php
 *    	\ingroup	ticket
...
$langs->loadLangs(array('companies', 'other', 'eservices@eservices'));
...
$url_page_current = DOL_URL_ROOT.'/custom/eservices/ticket/agenda.php';
...
$linkback = '<a href="'.DOL_URL_ROOT.'/custom/eservices/ticket/list.php"><strong>'.$langs->trans("BackToList").'</strong></a> ';
...
if (!empty($object->id)) {
	...
	$messagingUrl = DOL_URL_ROOT.'/custom/eservices/ticket/messaging.php?track_id='.$object->track_id;
