...
/**
 *  \file       htdocs/custom/eservices/ticket/document.php
 *  \ingroup    ticket
...
$langs->loadLangs(array("companies", "other", "eservices@eservices", "mails"));
...
$url_page_current = DOL_URL_ROOT.'/custom/eservices/ticket/document.php';
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/custom/eservices/ticket/list.php', 1).'"><strong>'.$langs->trans("BackToList").'</strong></a> ';
