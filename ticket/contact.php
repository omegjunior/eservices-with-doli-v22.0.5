...
/**
 *       \file       htdocs/custom/eservices/ticket/contact.php
 *       \ingroup    ticket
...
$langs->loadLangs(array('companies', 'eservices@eservices'));
...
$url_page_current = DOL_URL_ROOT.'/custom/eservices/ticket/contact.php';
