...
class modEservices extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$result29=$extrafields->addExtraField('3_sexe', "Sexe", 'radio', 340, '', 'ticket', 0, 1, '', array('options' => array('1' => 'Homme', '2' => 'Femme')), 0, '', '1', '', '', '', 'eservices@eservices', 'isModEnabled("eservices")');
		$result18=$extrafields->addExtraField('3_rattachement', "Rattachement", 'radio', 350, '', 'ticket', 0, 1, '', array('options' => array('1' => 'Diocèse', '2' => 'Institut - Congrégation - Ordre - Société - Communauté')), 0, '', '1', '', '', '', 'eservices@eservices', 'isModEnabled("eservices")');
