...
/**
 *	\file       eservices/eservicesindex.php
 *	\ingroup    eservices
 *	\brief      Home page of eservices top menu
 */
...
$langs->loadLangs(array("eservices@eservices"));
...
// Load translation files required by the page
$langs->loadLangs(array("companies", "admin", "eservices@eservices"));

if (!$user->admin || !isModEnabled('eservices')) {
	accessforbidden();
}
 ...
 * View
 */
$title = $langs->trans("opcacheadmin");
/*
 * User configuration
...
$title = "Zend OPcache Statistiques sur le serveur ". $opcache->getData('version', 'host');

llxHeader('', 'Admin OPcache');

print load_fiche_titre($title, '', 'opcaheadmin');
