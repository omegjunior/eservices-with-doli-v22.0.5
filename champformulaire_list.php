...
print load_fiche_titre($langs->trans("ListChampForm"), '', 'fa-cogs');


require DOL_DOCUMENT_ROOT.'/custom/eservices/core/tpl/admin_extrafields_view.tpl.php';
...
if ($action == 'edit' && !empty($attrname)) {
	...
	include DOL_DOCUMENT_ROOT.'/custom/eservices/core/tpl/admin_extrafields_edit.tpl.php';
}
